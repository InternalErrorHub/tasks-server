...
public class ServerExceptionHandler {
    ...
    public ResponseEntity<Map<String, List<String>>> validationException(ValidationException e) {
        return new ResponseEntity<>(getErrorsMap(List.of(e.getMessage())), HttpStatus.BAD_REQUEST);
    }
